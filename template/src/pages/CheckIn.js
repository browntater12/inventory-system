const CheckIn = () => {
    return(
        <div className="checkin">
            <h1 style={{marginTop: 100, marginBottom: 40}}>Add Inventory to Warehouse</h1>
            <div class='container'>
                <div class='row'>
            ...
            <div class='btn-group' style={{marginTop: 40 }}>
                <div class='row'>
                    <div class='col'>
                        <button type="button" class="btn btn-primary" style={{height: 50, width: 150}}>Check In</button>
                    </div>
                    <div class='col'>
